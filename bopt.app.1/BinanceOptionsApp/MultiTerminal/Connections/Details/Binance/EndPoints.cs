namespace MultiTerminal.Connections.Details.Binance
{
    ...
    public static class EndPoints
    {
        ...
        public static readonly BinanceEndPoint AccountInformation = new BinanceEndPoint("/eapi/v3/account", "GET", true);
        ...
        #region Account Endpoints [SPOT/MARGIN] FUTURES
        public static readonly BinanceEndPoint NewOrderFuture = new BinanceEndPoint("/api/v3/order", "POST", true);
        ...
        public static readonly BinanceEndPoint MarginAccountInformationFuture = new BinanceEndPoint("/fapi/v2/account", "GET", true);
        ...
        public static readonly BinanceEndPoint SpotCreateListenKeyFuture = new BinanceEndPoint("/fapi/v1/ping", "GET", false);
        ...
        public static readonly BinanceEndPoint MarginCreateListenKeyFuture = new BinanceEndPoint("/fsapi/v1/userDataStream", "POST", false);
        public static readonly BinanceEndPoint MarginUpdateListenKeyFuture = new BinanceEndPoint("/fsapi/v1/userDataStream", "PUT", false);
        public static readonly BinanceEndPoint MarginDeleteListenKeyFuture = new BinanceEndPoint("/fsapi/v1/userDataStream", "DELETE", false);
