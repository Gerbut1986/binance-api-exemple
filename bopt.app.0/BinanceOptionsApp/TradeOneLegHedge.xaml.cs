...
namespace BinanceOptionsApp
{
    public partial class TradeOneLegHedge : UserControl, IConnectorLogger, ITradeTabInterface
    {
        ...
        void OnSlowLogin()
        {
            ...
            slowConnector.Subscribe(model.OPTION.FullSymbol, model.OPTION.GetSymbolId());
        }
        void OnFastLogin()
        {
            fastConnector.Fill = (FillPolicy)model.Open.Fill;
            fastConnector.Subscribe(model.SPOT.FullSymbol, model.SPOT.GetSymbolId());
        }
        ...
        private void SlowConnector_Tick(object sender, TickEventArgs e)
        {
            if (e.Symbol == model.OPTION.FullSymbol)
            {
                ...
                model.OPTION.Bid = e.Bid;
                model.OPTION.Ask = e.Ask;
