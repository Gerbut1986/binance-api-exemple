...
namespace BinanceOptionsApp
{
    ...
    internal static class Model
    {
        ...
        public static bool IsAlgoSupported(TradeAlgorithm algo) => algo == TradeAlgorithm.OneLegHedge && Model.UseOneLegHedge || algo == TradeAlgorithm.OneLeg && Model.UseOneLeg || (algo == TradeAlgorithm.TwoLegLock && Model.UseTwoLegLock || algo == TradeAlgorithm.TwoLegSimpleHedge && Model.UseTwoLegSimple) || (algo == TradeAlgorithm.MultiLegSpread && Model.UseMultiLeg || algo == TradeAlgorithm.OneLegMulti && Model.UseOneLegMulti || (algo == TradeAlgorithm.OneLegHidden && Model.UseOneLegHidden || algo == TradeAlgorithm.TwoLegStandard && Model.UseTwoLegStandard)) || algo == TradeAlgorithm.ThreeLeg && Model.UseThreeLeg;
        ...
        public static void InitializeLicense()
        {
            ...
            Model.UseFreezeTime = Model.IsSubscriptionFeaturePresent("Private7.FreezeTime");
            Model.UseOneLegHidden = Model.IsSubscriptionFeaturePresent("Private7.1LegHidden");
            Model.UseTwoLegStandard = Model.IsSubscriptionFeaturePresent("Private7.2LegStandard");
            Model.UseThreeLeg = Model.IsSubscriptionFeaturePresent("Private7.3Leg");
